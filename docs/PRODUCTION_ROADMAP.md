...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 2.1 | Wire **Hot feed** (`FeedSortMode.HOT`) in UI | P0 | [x] |
| 2.2 | Category picker in composer + feed filter | P0 | [x] |
| 2.3 | Real pull-to-refresh (invalidate Firestore listener) | P1 | [x] |
| 2.4 | **Public user profiles** (tap author → posts + badges) | P0 | [x] |
| 2.5 | **In-app notification inbox** | P0 | [x] |
| 2.6 | Feed pagination / cursor-based loading | P1 | [x] |
| 2.7 | City expansion gates (`isExpansionUnlocked`) in UI | P2 | [x] |
| 2.8 | Onboarding tooltips (first Snap, feels, locality filter) | P2 | [x] |
...
| # | Task | Priority | Status |
|---|------|----------|--------|
| 3.1 | Premium save UI (`toggleSaveThought`) | P0 | [x] |
| 3.2 | Google Play Billing (₹99/mo) | P0 | [~] UI ready; wire Play Console product |
| 3.3 | Sponsored post ops workflow (beyond seed script) | P1 | [x] lead form + display |
| 3.4 | Premium upsell on profile (replace placeholder) | P1 | [x] |
